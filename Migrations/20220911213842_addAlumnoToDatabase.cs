    ...
    public partial class addAlumnoToDatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GradoSeccion", x => x.IdGradoSeccion);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdSubMenu = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IdMenu = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubMenu", x => x.IdSubMenu);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NivelDetalle", x => x.IdNivelDetalle);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NivelDetalleCurso", x => x.IdNivelDetalleCurso);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DocenteCurso", x => x.IdDocenteCurso);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Concentrado", x => x.IdConcentrado);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Matricula_IdNivelDetalle",
                table: "Matricula",
                column: "IdNivelDetalle");

            migrationBuilder.CreateIndex(
                name: "IX_Matricula_IdNivelDetalleCurso",
                table: "Matricula",
                column: "IdNivelDetalleCurso");
